                ...
                <div v-if="activeTab === 'profile'" class="space-y-8 animate-pop-up">
                  ...
                  <div class="flex flex-col sm:flex-row items-center gap-6 p-6 bg-gradient-to-r from-pink-50/30 via-rose-50/15 to-indigo-50/15 border border-pink-100/20 rounded-[2rem] shadow-2xs">
                    <div class="relative group">
                      <div class="w-24 h-24 rounded-full bg-gradient-to-tr from-[#FF758F] to-[#FF4D6D] border-4 border-white flex items-center justify-center text-white font-fredoka font-extrabold text-3xl shadow-md transition-transform duration-300 group-hover:scale-105 select-none">
                        {{ teacherProfile.avatarInitials }}
                      </div>
                      <div class="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-white border border-slate-100 flex items-center justify-center text-slate-500 shadow-sm cursor-pointer hover:text-[#FF758F] hover:scale-110 transition-all">
